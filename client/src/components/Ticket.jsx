  ...
  return (
    <div className="hidden print:block text-black text-xs w-full max-w-[80mm] font-mono" style={{ fontFamily: '"Courier New", Courier, monospace' }}>
      ...
      <div className="text-center mb-2">
        <h2 className="text-3xl mb-1" style={{ fontFamily: '"Brush Script MT", "Lucida Handwriting", "Edwardian Script ITC", cursive', fontWeight: '400', letterSpacing: '0.05em' }}>Santiago Perfumes</h2>
